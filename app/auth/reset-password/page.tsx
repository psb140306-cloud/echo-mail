      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 px-4 relative">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">재설정 메일 발송 완료</h2>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="text-left space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <h3 className="font-medium text-gray-900 dark:text-white">다음 단계:</h3>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 px-4 relative">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">비밀번호 재설정</h2>
