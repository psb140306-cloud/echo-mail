...
-- CreateIndex
CREATE INDEX "email_logs_tenantId_folder_idx" ON "email_logs"("tenantId", "folder");

-- CreateIndex
CREATE INDEX "email_logs_tenantId_isRead_idx" ON "email_logs"("tenantId", "isRead");

-- CreateIndex
CREATE INDEX "email_logs_tenantId_isOrder_idx" ON "email_logs"("tenantId", "isOrder");
